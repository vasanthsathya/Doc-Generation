...
5. Configure the Ethernet switch for lossless RoCE traffic:
...
2. Verify RDMA devices are available:
...
4. Test RDMA bandwidth over RoCE:
...
6. Verify PFC counters (should show no drops):
