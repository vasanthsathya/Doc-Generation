...
+==============+===========================================+======================+=============+=============+===================================================+===================+
| 0e327d3addf0 | docker.io/minio/minio:latest              | server /data --co... | 2 hours ago | Up 2 hours  | 0.0.0.0:9000-9001->9000-9001/tcp                  | minio-server      |
+--------------+-------------------------------------------+----------------------+-------------+-------------+---------------------------------------------------+-------------------+
| 1439b4ba453e | docker.io/library/registry:latest         | /etc/distribution... | 2 hours ago | Up 2 hours  | 0.0.0.0:5000->5000/tcp                            | registry          |
+--------------+-------------------------------------------+----------------------+-------------+-------------+---------------------------------------------------+-------------------+
| 01c7a7eaeb7d | localhost/omnia_core:1.0                  | /bin/sh -c   mkdi..  | 3 hours ago | Up 3 hours  | 2222/tcp                                          | omnia_core        |
+--------------+-------------------------------------------+----------------------+-------------+-------------+---------------------------------------------------+-------------------+
| 3087ca8e0324 | localhost/omnia_auth:1.0                  | /opt/bitnami/scri... | 2 hours ago | Up 2 hours  | 0.0.0.0:389->389/tcp, 0.0.0.0:636->636/tcp        | omnia_auth        |
+--------------+-------------------------------------------+----------------------+-------------+-------------+---------------------------------------------------+-------------------+
