...
- Omnia does not support automatic deletion of the nodes using playbooks. However, you can reprovision the nodes. To reprovision the nodes, see Re-provisioning the cluster. 
...
- Support for Kube controllers is through manual diskfull installation only.
