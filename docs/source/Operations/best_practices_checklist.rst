...
.. list-table::
   ...
   * - ☐
     ...
     - `Prerequisites Checklist <../GetStarted/prerequisites_checklist.rst>`_
   * - ☐
   ...
   * - ☐
     ...
     - `Security Hardening <security_hardening.rst>`_
...
.. list-table::
   ...
   * - ☐
     ...
     - `Setup Telemetry <../HowTo/Telemetry/setup_telemetry.rst>`_
   * - ☐
     ...
     - `Deploy Powerscale Csi <../HowTo/Kubernetes/deploy_powerscale_csi.rst>`_
   * - ☐
     ...
     - `Configure Nfs <../HowTo/Storage/configure_nfs.rst>`_
...
.. list-table::
   ...
   * - ☐
     ...
     - `General <../Troubleshooting/general.rst>`_
   * - ☐
...
.. note::
   ...
   - `Prerequisites Checklist <../GetStarted/prerequisites_checklist.rst>`_ -- Detailed prerequisites for
     all deployment paths.
   - `Security Hardening <security_hardening.rst>`_ -- Full security hardening procedures.
   - `Log Management <log_management.rst>`_ -- Log monitoring and rotation configuration.
