...
.. list-table::
   ...
   * - ☐
     ...
     - `Prerequisites Checklist <../GetStarted/prerequisites_checklist.md>`_
   * - ☐
   ...
   * - ☐
     ...
     - `Security Hardening <security_hardening.md>`_
...
.. list-table::
   ...
   * - ☐
     ...
     - `Setup Telemetry <../HowTo/Telemetry/setup_telemetry.md>`_
   * - ☐
     ...
     - `Deploy Powerscale Csi <../HowTo/Kubernetes/deploy_powerscale_csi.md>`_
   * - ☐
     ...
     - `Configure Nfs <../HowTo/Storage/configure_nfs.md>`_
...
.. list-table::
   ...
   * - ☐
     ...
     - `General <../Troubleshooting/general.md>`_
   * - ☐
...
.. note::
   ...
   - `Prerequisites Checklist <../GetStarted/prerequisites_checklist.md>`_ -- Detailed prerequisites for
     all deployment paths.
   - `Security Hardening <security_hardening.md>`_ -- Full security hardening procedures.
   - `Log Management <log_management.md>`_ -- Log monitoring and rotation configuration.
