...
To configure OpenManage Enterprise to stream telemetry data to Kafka, see :doc:`../ome_telemetry/ome_kafka_integration`.
...
.. note:: To configure OpenManage Enterprise to stream telemetry data to Kafka, see :doc:`../ome_telemetry/ome_kafka_integration`.
