...
For collecting telemetry data from Smart Fabric Manager (SFM) to Victoria DB, see :doc:`../sfm_telemetry/sfm_victoriametrics_integration`.
...
.. note:: For collecting telemetry data from Smart Fabric Manager (SFM) to Victoria DB, see :doc:`../sfm_telemetry/sfm_victoriametrics_integration`.
