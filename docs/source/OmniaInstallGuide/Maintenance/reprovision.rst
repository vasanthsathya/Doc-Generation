...
If you deploy the service kubernetes cluster or slurm cluster freshly, ensure that the nfs server share path used by slurm or service kubernetes cluster is cleared manually. The NFS data is available in the ``storage_config.yml``.
