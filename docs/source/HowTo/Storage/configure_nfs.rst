...
2. Verify NFS is mounted on compute nodes:
...
3. Test read/write from a compute node:
...
5. Verify mount persists across reboot:
...
.. code-block:: text
   :caption: File: /etc/exports on NFS server node
...
.. code-block:: text
   :caption: File: /etc/fstab on compute node
