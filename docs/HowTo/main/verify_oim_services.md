...
## Prerequisites
- The [Prepare OIM](../main/setup_oim.md) procedure has been completed successfully.
...
9. **Verify PowerScale S3 connection** (if PowerScale is configured as S3 storage):
    ...
    See [Configure PowerScale as S3 storage](../main/setup_oim.md) for setup instructions.
...
- [Create Local Repos](../repo_manager/configure_repos.md) -- Sync RPM repositories via Pulp.
- [Build Cluster Images](../image_build_manager/build_images.md) -- Build OS boot images.
- [Discover Nodes](../discovery/discover_nodes.md) -- Discover and provision bare-metal servers.
