 ...
 * Configure Inputs [ Configure Inputs ](configure_inputs.html) Table of contents 
 * [ Overview ](#overview)
 * Slurm Slurm 
 ...
 * [Configure Credentials](configure_credentials.html) \-- Set up encrypted credentials for provisioning.
 * [Prepare Oim](prepare_oim.html) \-- Prepare OIM services (OpenCHAMI, Pulp, etc.).
...
Back to top [ Previous Prepare OIM ](prepare_oim.html) [ Next Configure Credentials ](configure_credentials.html)
