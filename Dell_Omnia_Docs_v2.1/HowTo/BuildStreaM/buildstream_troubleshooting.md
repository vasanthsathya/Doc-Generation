 ...
 * [ Deploy GitLab ](deploy_gitlab.html)
 * BuildStreaM Troubleshooting [ BuildStreaM Troubleshooting ](buildstream_troubleshooting.html) Table of contents 
 * [ Overview ](#overview)
 ...
 * [ Overview ](#overview)
 ...
 3. [ BuildStreaM ](deploy_gitlab.html)
 ...
 * GitLab is deployed (see [Deploy Gitlab](deploy_gitlab.html)).
 * A BuildStreaM catalog is configured (see [Update Catalog Pipeline](update_catalog_pipeline.html)).
 ...
 * [Update Catalog Pipeline](update_catalog_pipeline.html) \-- Resume catalog-driven deployments.
 * [Deploy Gitlab](deploy_gitlab.html) \-- Reconfigure GitLab if needed.
 ...
 * Open an issue on the `Omnia GitHub repository <https://github.com/dell/omnia/issues>`_ for Omnia-specific issues.

Back to top [ Previous Update Catalog Pipeline ](update_catalog_pipeline.html) [ Next Reference ](../../Reference/index.html)
