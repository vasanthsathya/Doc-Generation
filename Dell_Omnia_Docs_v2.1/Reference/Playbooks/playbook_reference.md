 ...
 * Playbooks Playbooks 
 * Playbook Reference [ Playbook Reference ](playbook_reference.html) Table of contents 
 * [ Playbook summary table ](#playbook-summary-table)
 * Metrics Metrics 
 ...
 * [ Playbook summary table ](#playbook-summary-table)
 ...
 3. [ Playbooks ](playbook_reference.html)
 ...
 * [Provision Config](../Configuration/provision_config.html) \-- Provisioning parameters.
 * [Omnia Config](../Configuration/omnia_config.html) \-- Cluster deployment parameters.
 * [Pxe Mapping File](../SampleFiles/pxe_mapping_file.html) \-- PXE mapping CSV format.

Back to top [ Previous Ports ](../ClusterRequirements/ports.html) [ Next iDRAC Metrics ](../Metrics/idrac_metrics.html)
