 ...
 * [Network Spec](../Configuration/network_spec.html) \-- Full `network_spec.yml` parameter reference.
 * [Switches](switches.html) \-- Switch models and VLAN configuration.
 * [Nics](nics.html) \-- Supported NIC models for each topology.

Back to top [ Previous Operating Systems ](operating_systems.html) [ Next NICs ](nics.html)
