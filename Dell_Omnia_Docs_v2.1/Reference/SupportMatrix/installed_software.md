 ...
 * Installed Software [ Installed Software ](installed_software.html) Table of contents 
 * [ OIM (Management Node) software ](#oim-management-node-software)
 ...
 * [Software Config](../Configuration/software_config.html) \-- How software packages are selected for installation via `software_config.json`.
 * [Local Repo Config](../Configuration/local_repo_config.html) \-- Repository mirror configuration for package sources.
 * [Software Config Json](../SampleFiles/software_config_json.html) \-- Sample `software_config.json` for different deployment scenarios.

Back to top [ Previous Storage ](storage.html) [ Next Omnia Config ](../Configuration/omnia_config.html)
