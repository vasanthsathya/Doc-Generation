 ...
 * Path B: Full Deployment [ Path B: Full Deployment ](full_deployment.html) Table of contents 
...
Complete the [Prerequisites Checklist](prerequisites_checklist.html) before proceeding. Pay special attention to the **Service Kubernetes Requirements** section -- you need 3 control-plane nodes with 64 GB RAM each.
...
**Enable BuildStreaM for GitOps** See [Buildstream Deployment](buildstream_deployment.html) (Path D) to layer CI/CD automation on top of this deployment.

Info

 * [Slurm Quickstart](slurm_quickstart.html) \-- Simplified 4-node Slurm deployment
 * [K8S Telemetry Only](k8s_telemetry_only.html) \-- Telemetry without Slurm
 * [Prerequisites Checklist](prerequisites_checklist.html) \-- Master checklist

Back to top [ Previous Path A: Slurm Quickstart ](slurm_quickstart.html) [ Next Path C: Kubernetes & Telemetry ](k8s_telemetry_only.html)
