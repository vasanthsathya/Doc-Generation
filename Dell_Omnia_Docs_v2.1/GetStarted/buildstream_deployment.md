 ...
 * Path D: BuildStreaM [ Path D: BuildStreaM ](buildstream_deployment.html) Table of contents 
...
Complete the [Prerequisites Checklist](prerequisites_checklist.html) before proceeding. In addition, BuildStreaM requires:
...
Edit `network_spec.yml`, `provision_config.yml`, and `ha_config.yml` as described in [Full Deployment](full_deployment.html) Steps 5a--5c.
 ...
 * [Full Deployment](full_deployment.html) \-- Manual equivalent of this automated path
 * [Prerequisites Checklist](prerequisites_checklist.html) \-- Master checklist
 * [Slurm Quickstart](slurm_quickstart.html) \-- Simplified manual deployment for comparison

Back to top [ Previous Path C: Kubernetes & Telemetry ](k8s_telemetry_only.html) [ Next How-to Guides ](../HowTo/index.html)
